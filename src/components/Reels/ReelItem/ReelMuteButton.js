...
export const ReelMuteButton = ({ isMuted, onToggle }) => {
  return (
    <button
      onClick={onToggle}
      className="absolute top-20 right-4 z-20 bg-black/50 hover:bg-black/70 rounded-full p-2 backdrop-blur-sm transition-all duration-200"
